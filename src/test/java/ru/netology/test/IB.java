...
public class IB {
    ...
    @Test
    public void noAuthNotRegistrationUser() {
    ...
    @Test
    public void noAuthInvalidLogin() {
    ...
    @Test
    public void noAuthInvalidPassword() {
        form.$x(".//span[@data-test-id='login']//child::input").val(userActive.getLogin());
